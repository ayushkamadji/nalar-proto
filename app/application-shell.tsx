        ...
        <div className="overflow-y-auto py-5 px-3 h-full bg-white dark:bg-gray-800">
          ...
          <ul className="space-y-2">
            <li>
              ...
              >
                <svg aria-hidden="true" className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M10.707 2.293a1 1 0 00-1.414 0l-7 7a1 1 0 001.414 1.414L4 10.414V17a1 1 0 001 1h2a1 1 0 001-1v-2a1 1 0 011-1h2a1 1 0 011 1v2a1 1 0 001 1h2a1 1 0 001-1v-6.586l.293.293a1 1 0 001.414-1.414l-7-7z"></path></svg>
            ...
            <li>
              <Link
                href={`/report?fullName=${fullName}&email=${email}&nik=${nik}&phone=${phone}`}
                className="flex items-center p-2 text-base font-medium text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
              >
                <svg
                  aria-hidden="true"
                ...
                <span className="ml-3">Fraud Report</span>
              </Link>
            </li>
            <li>
              <Link
                href={`/bank?fullName=${fullName}&email=${email}&nik=${nik}&phone=${phone}`}
                className="flex items-center p-2 text-base font-medium text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
              >
                <svg
                  aria-hidden="true"
                ...
                <span className="ml-3">Bank Analyzer</span>
              </Link>
            </li>
          </ul>
          <ul
